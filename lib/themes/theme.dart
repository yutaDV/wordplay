...
class AppThemes {
  ...
  static  const TextTheme _lightTextTheme = TextTheme(
    ...
    bodyMedium: TextStyle(fontSize: 16.0, fontWeight: FontWeight.w300, color: _lightPrimaryColor,  letterSpacing: 0.2, height: 1.1,),
    bodySmall: TextStyle(fontSize: 12.0, fontWeight: FontWeight.w300, color: _lightPrimaryColor,  letterSpacing: 0.2, height: 1.1,),
  ...
  static  const TextTheme darkTextTheme = TextTheme(
    ...
    bodyMedium: TextStyle(fontSize: 16.0, fontWeight: FontWeight.w300, color: _darkPrimaryColor,  letterSpacing: 0.2, height: 1.1,),
    bodySmall: TextStyle(fontSize: 20.0, fontWeight: FontWeight.w300, color: _darkPrimaryColor,  letterSpacing: 0.2, height: 1.1,),
